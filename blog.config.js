...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Ylarod', // 作者
  BIO: process.env.NEXT_PUBLIC_BIO || '纳西妲世界第一可爱！', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xtuly.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Ylarod, 博客, Blog', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: 'me@ylarod.cn', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/Ylarod', // 你的github个人主页
...
<<<<<<< HEAD
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'ylarod/Blog', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  COMMENT_GISCUS_REPO_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'R_kgDOIc4cAQ', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
  COMMENT_GISCUS_CATEGORY_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOIc4cAc4CSm7z', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
...
>>>>>>> 2749b73e08762677e67fc7c6a82063dcea23169d
