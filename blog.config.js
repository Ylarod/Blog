...
const BLOG = {
  ...
  CONTACT_EMAIL: 'me@ylarod.cn',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/Ylarod',
  CONTACT_TELEGRAM: '',
  ...
  COMMENT_GISCUS_CATEGORY_ID:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOIc4cAc4CSm7z', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
